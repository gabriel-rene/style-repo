...
const TERMS = [
  ...
  // 2026-09-24: added from the user's style list. Guides are editorial.
  { id: 'claymorphism', type: 'aesthetic', name: 'Claymorphism',
    formal: { grid_discipline: 'moderate', palette_logic: { descriptor: 'pastel', note: 'soft candy pastels; inner and outer shadows' }, contrast: 'low', texture: 'subtle', hierarchy: 'moderate', ornament_level: 'minimal' },
    stance: 'mixed', contexts: ['web-ui', 'product', 'advertising'],
    guide: { dek: 'Rounded, inflated shapes with soft inner and outer shadows make interface elements look like pressed clay.',
      signature: ['Puffy rounded forms', 'Pastel fills', 'Paired soft shadows'],
      application: 'Keep text on plain, high-contrast surfaces rather than on shaded forms.',
      caution: 'Soft, low-contrast shadows can hide which elements are interactive.',
      compare: ['neumorphism', 'skeuomorphism'] } },
  { id: 'glassmorphism', type: 'aesthetic', name: 'Glassmorphism',
    formal: { grid_discipline: 'moderate', palette_logic: { descriptor: 'full-spectrum', note: 'vivid gradient backdrops behind frosted panels' }, contrast: 'low', texture: 'subtle', hierarchy: 'moderate', ornament_level: 'minimal' },
    stance: 'mixed', contexts: ['web-ui', 'product'],
    guide: { dek: 'Translucent, blurred panels float above colorful backgrounds like sheets of frosted glass.',
      signature: ['Background blur', 'Semi-transparent panels', 'Thin light borders'],
      application: 'Test text contrast over the brightest and darkest parts of the background.',
      caution: 'Blur alone is not a hierarchy; many stacked glass layers become muddy.',
      compare: ['frutiger-aero', 'flat-design', 'neumorphism'] } },
  { id: 'neumorphism', type: 'aesthetic', name: 'Neumorphism',
    formal: { grid_discipline: 'moderate', palette_logic: { descriptor: 'monochrome', note: 'one background hue; light and dark shadows only' }, contrast: 'low', texture: 'subtle', hierarchy: 'flat', ornament_level: 'minimal' },
    stance: 'mixed', contexts: ['web-ui', 'product'],
    guide: { dek: 'Controls seem pressed out of, or into, one soft surface through paired light and dark shadows.',
      signature: ['Same-color surfaces', 'Paired soft shadows', 'Low-contrast relief'],
      application: 'Add labels, focus rings and state changes that do not rely on shadow alone.',
      caution: 'Very low contrast often fails accessibility guidelines.',
      compare: ['skeuomorphism', 'claymorphism', 'flat-design'] } },
  { id: 'neo-brutalism', type: 'style', name: 'Neo-Brutalism',
    formal: { grid_discipline: 'moderate', palette_logic: { descriptor: 'restricted', note: 'flat saturated brights with heavy black outlines' }, contrast: 'high', texture: 'flat', hierarchy: 'moderate', ornament_level: 'minimal' },
    stance: 'expressive', contexts: ['web-ui', 'advertising', 'corporate-identity'],
    guide: { dek: 'Thick black outlines, hard offset shadows and flat bright colors give an interface a bold, deliberately blunt look.',
      signature: ['Heavy black borders', 'Hard offset shadows', 'Flat saturated fills'],
      application: 'Use the heavy frame to single out a few key actions, not every element.',
      caution: 'Keep this distinct from raw brutalist web design, which avoids a polished color system.',
      compare: ['brutalist-web-design', 'flat-design'] } },
  { id: 'bento-grid', type: 'style', name: 'Bento grid',
    formal: { grid_discipline: 'strict', palette_logic: { descriptor: 'restricted', note: 'often a neutral ground with one accent per tile' }, contrast: 'medium', texture: 'flat', hierarchy: 'strict', ornament_level: 'minimal' },
    stance: 'rationalist', contexts: ['web-ui', 'product', 'corporate-identity'],
    guide: { dek: 'Content is split into rounded tiles of different sizes, packed into one tidy grid like a bento box.',
      signature: ['Modular tiles of varied size', 'Rounded corners', 'One idea per tile'],
      application: 'Size tiles by importance and keep a clear reading order on small screens.',
      caution: 'Giving every tile equal weight removes the hierarchy the grid should create.',
      compare: ['swiss-international-style', 'minimalism'] } },
  { id: 'cybercore', type: 'aesthetic', name: 'Cybercore',
    formal: { grid_discipline: 'loose', palette_logic: { descriptor: 'fluorescent', note: 'neon on black; digital greens and blues' }, contrast: 'high', texture: 'pronounced', hierarchy: 'chaotic', ornament_level: 'high' },
    stance: 'expressive', contexts: ['fashion', 'music-packaging', 'web-ui'],
    guide: { dek: 'Digital grids, neon light and computer imagery build a future imagined through technology.',
      signature: ['Neon on black', 'Circuit and grid motifs', 'Pixel and techno type'],
      application: 'Keep one readable text layer above the technical decoration.',
      caution: 'Keep it distinct from cyberpunk, which adds urban decay and a dystopian story.',
      compare: ['cyberpunk-aesthetic', 'y2k-aesthetic', 'glitch-art'] } },
  { id: 'scrapbook', type: 'style', name: 'Scrapbook',
    formal: { grid_discipline: 'broken', palette_logic: { descriptor: 'other', note: 'paper, tape and photo tones; mixed found colors' }, contrast: 'medium', texture: 'pronounced', hierarchy: 'moderate', ornament_level: 'high' },
    stance: 'expressive', contexts: ['editorial', 'self-published', 'advertising', 'web-ui'],
    guide: { dek: 'Photos, paper scraps, tape and handwritten notes are layered as if pasted into a personal album.',
      signature: ['Taped and torn edges', 'Paper textures', 'Handwritten notes'],
      application: 'Give each page one main image and let the pasted pieces support it.',
      caution: 'Too many stickers and textures turn a personal layout into clutter.',
      compare: ['collage', 'maximalism'] } },
  { id: 'wabi-sabi', type: 'style', name: 'Wabi-sabi',
    formal: { grid_discipline: 'loose', palette_logic: { descriptor: 'restricted', note: 'earthy, muted natural tones' }, contrast: 'low', texture: 'pronounced', hierarchy: 'moderate', ornament_level: 'minimal' },
    stance: 'mixed', contexts: ['product', 'editorial', 'architecture'],
    guide: { dek: 'Muted natural materials, asymmetry and visible wear express a quiet beauty in imperfection.',
      signature: ['Earthy muted palette', 'Natural textures', 'Asymmetry and restraint'],
      application: 'Let real texture and empty space carry the mood instead of added ornament.',
      caution: 'It names a broader aesthetic philosophy, not only a muted color palette.',
      compare: ['minimalism'] } },
];
...
for (const t of TERMS) {
  ...
  if (t.guide) provenance.guide = [{ source: 'editorial', reviewed: false }];
